...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Hestia/Hestia.framework"
  install_framework "${PODS_ROOT}/HestiaIOS/HestiaIOS.framework"
  ...
  install_framework "${PODS_ROOT}/TrackingBridge/TrackingBridge.framework"
  install_framework "${PODS_ROOT}/TripiCommon/TripiCommon.framework"
  install_framework "${PODS_ROOT}/TripiFlightConnector/TripiFlightConnector.framework"
