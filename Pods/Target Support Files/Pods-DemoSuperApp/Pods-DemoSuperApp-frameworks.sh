...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Minerva/Minerva.framework"
  ...
  install_framework "${PODS_ROOT}/RxMoya/RxMoya.framework"
  ...
  install_framework "${PODS_ROOT}/TekCrmService/TekCrmService.framework"
  install_framework "${PODS_ROOT}/TekDiscoveryService/TekDiscoveryService.framework"
  install_framework "${PODS_ROOT}/TekIdentityService/TekIdentityService.framework"
  install_framework "${PODS_ROOT}/TekListingService/TekListingService.framework"
  install_framework "${PODS_ROOT}/TekLocationService/TekLocationService.framework"
  install_framework "${PODS_ROOT}/TekOrderService/TekOrderService.framework"
  install_framework "${PODS_ROOT}/TekPolicyService/TekPolicyService.framework"
  install_framework "${PODS_ROOT}/TekPpmService/TekPpmService.framework"
  install_framework "${PODS_ROOT}/TekSearchService/TekSearchService.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TekServiceInterfaces/TekServiceInterfaces.framework"
  install_framework "${PODS_ROOT}/TekStnService/TekStnService.framework"
  install_framework "${PODS_ROOT}/TekTicketService/TekTicketService.framework"
  install_framework "${PODS_ROOT}/TekUserService/TekUserService.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TekoMediaPreview/TekoMediaPreview.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TekoTracker/TekoTracker.framework"
  ...
  install_framework "${PODS_ROOT}/TripiCommon/TripiCommon.framework"
  install_framework "${PODS_ROOT}/TripiFlightKit/TripiFlightKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VPAttributedFormat/VPAttributedFormat.framework"
